    ...
    <div class="row">
        <div class="col-xl-4 col-lg-4 col-md-7  col-sm-4">
            ...
            <div class="phase_sale mb-4">
                ...
                <p>{{$now->name}}</p>
                <input class="form-control" disabled value="{{$wtabalanceOf_owner}}" />
                <strong id="now" data-time="{{$now->end_date}}"></strong>
            ...
            <div class="phase_sale mb-4">
                ...
                <input class="form-control" disabled value="{{number_format($coming->first()->token_number,0,'','.')}}" />
                <strong id="now" data-time="{{$coming->first()->start_date}}"><span class="test"></span></strong>
                <div id="now-show" class="text-center count_down"></div>
            </div>
            @endif
        ...
        <div class="col-xl-8 col-lg-8 col-md-12 col-sm-8">
            @if(!empty($now))
                @if($max_buy_remaining<$now->max_buy)
                <div class="rate">
                    <div class="loading">
                        <i class="ti-reload"></i>
                    </div>
                    <form>
                        ...
                        <div class="mb-3">
                            <div style="display:flex;width:100%">
                                ...
                                <span style="display:flex;width:100%;justify-content: flex-end;">Balance: <span style="margin-left: 5px;">{{$bnb_balance}}</a></span></span>
                            </div>
                            <input type="text" class="form-control input_buy_bnb" disabled id="bnb_balance" name="bnb_quantity" max="{{$bnb_balance}}" placeholder="" value="">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{$order->name}}</td>
                                <td>{{number_format($order->quantity_token)}}</td>
                                <td>
                                    {{$order->quantity_bnb==0?'Updating':$order->quantity_bnb}}
                                </td>
                                @if($order->status == 1)
                                <td>Pending</td>
