            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-4">
                <div class="info">
                    ...
                    <div class="profile_sumany">
                        <div class="photo">
                            @if($user->photo)
                                <img src="{{asset('public/'.$user->photo)}}" alt="">
                            @else
                            <img src="/public/assets/images/4a4aefaeb6696571bc3c0307d5bd8a50.jpeg" />
                            @endif
                        </div>
                        <div class="content">
                            <p><span>Name</span><span>{{$user->fullname}}</span></p>
                            <p><span>Email</span><span>{{ substr_replace(auth()->user("web")->email,"***",0,5)}}</span>
                            </p>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 col-lg-6">
                                <div class="profile_form">
                                    <form method="POST" action="{{ route('ico.account.update_post') }}"
...
<!--                                    <a href="https://ekyc.live/?email={{$user->email}}&id={{$secret_key}}"-->
...
<!--                                    <p class="title-main">Coming soon</p>-->
                                    @else
                                    <a href="https://ekyc.live/?email={{$user->email}}&id={{$secret_key}}" class="action">Not yet</a>
                                    @endif
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-12">
                    ...
                    <div id="refferals" class="tab-pane fade" role="tabpanel">
                        <div class="referral">
                            ...
                            <div class="info">
                                <div class="item">
                                    ...
                                    <div class="input-group mb-3 input-primary">
                                        <input disabled type="text" id="referral_link"
                                               value="{{url('register/'.$user->referral_code)}}"
                                               class="form-control">

                                        <div class="input-group-append" style="cursor: pointer;"
                                             onclick="copyToClipboard('#referral_link','{{url('register/'.$user->referral_code)}}')">
                                ...
                                <div class="item">
                                    <p>Registered referral : {{$Registered}}</p>
<!--                                    <p>Bonus total: {{$bonus_value}} WTA</p>-->
                                    <p>Referral total: {{$referral_value}} WTA</p>
                                </div>
                            </div>
                        </div>
                        <div class="list card-common">
                            <div class="table-responsive" id="table_data">
                                @include("ICO::account.paginate")
                            </div>
                        </div>
