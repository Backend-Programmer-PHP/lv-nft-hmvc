        ...
        <tbody>
            <tr>
                <td style="text-align: center;padding: 30px;">
                    <img width="90" style="margin-bottom: 20px;" src="{{asset('public/upload/email/logo.png')}}" />
                    <p style="text-align: left;color: #663B59;margin-bottom:15px">Hi {{$email}},</p>
                    <p style="text-align: left;color: #663B59;">You have successfully changed your password at {{$time}}.
                    </p>
