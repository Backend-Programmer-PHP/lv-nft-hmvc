            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    @if($data['user']->google2fa_secret==null)
                        <form class="form-horizontal" method="POST" action="{{route('ico.auth.2fa.generate')}}">
                            {{ csrf_field() }}
                    ...
                    @elseif(!$data['user']->google2fa_enable)
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('ico.auth.2fa.enable') }}">
                            {{ csrf_field() }}
                    ...
                    @elseif($data['user']->google2fa_enable)
                        ...
                        <form class="form-horizontal" method="POST" action="{{ route('ico.auth.2fa.disable2fa') }}">
