                ...
                <div class="card-body">
                    ...
                    <form role="form" method="post" action="{{ route('ico.security.twoFace.verify') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="code" class="form-control" autocomplete="off" maxlength="6" id="otp">
                        </div>
                        <div class="form-group">
...
{{--                            Open the two-factor authentication app on your device to view your authentication code and verify your identity.--}}
                        <p>Don't have an account? <a class="text-primary" href="/logout.html">Logout</a>
