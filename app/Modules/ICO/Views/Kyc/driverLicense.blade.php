...
{{--                                            @endforeach--}}
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Image Driver License Front</label>
                                            <input type="file" class="form-control" name="img_driver_license_front"
                                                required>
                                            @if ($errors->has('img_driver_license_front'))
                                                <div class="alert alert-danger">
                                                    {{ $errors->first('img_driver_license_front') }}
                                                </div>
                                            @endif
{{--                                            @foreach ($errors->all() as $error)--}}
{{--                                                @if ($error[0] == 1)--}}
...
{{--                                            @endforeach --}}
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputPassword1">Image Driver License Behind</label>
                                            <input type="file" class="form-control" name="img_driver_license_behind"
                                                required>
                                            @if ($errors->has('img_driver_license_behind'))
                                                <div class="alert alert-danger">
                                                    {{ $errors->first('img_driver_license_behind') }}
                                                </div>
                                            @endif
{{--                                            @foreach ($errors->all() as $error)--}}
{{--                                                @if ($error[0] == 1)--}}
