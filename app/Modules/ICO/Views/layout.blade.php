...
<head>
    <meta charset="utf-8"/>
    <title>@yield('title') - WTA Wallet</title>
    ...
    <link href="/public/ico/assets/css/style.css?v={{time()}}" rel="stylesheet">
...
<!-- Begin page -->
<div id="main-wrapper">
    @include('ICO::inc.navheader')
    @include('ICO::inc.header')
    @include('ICO::inc.deznav')
    @show
...
<script src="/public/ico/assets/js/app.js?v={{time()}}"></script>
@yield('script')
<script>
