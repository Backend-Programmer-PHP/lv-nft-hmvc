            ...
            <div class="list_item">
                ...
                <div class="item">
                    <div class="number">
                        ...
                        <p id="bnb" data-qantity="{{$eth_balance}}">
                            @php
                            $bnb_balance= explode(".",$eth_balance);
                            @endphp
                            @if($bnb_balance[1]=="0000")
                            {{$bnb_balance[0]}}
    ...
    <div class="col-xl-8 col-lg-8 col-md-12 col-sm-8">
        ...
        <div class="phase_list">
            ...
            <div class="item">
                ...
                <p>{{$now->first()->name}}</p>
                <input class="form-control" value="{{$wtabalanceOf_owner}}" disabled />
                <p class="tb-time" data-time="{{$now->first()->end_date}}"><span class="test"></span></p>
                @if($user->kyc_status && $user->google2fa_enable)
                <!--a href="/token-sale/{{$now->first()->id}}" class="btn btn-buynow">Buy Now</a-->
            ...
            <div class="item">
                ...
                <p>{{$coming->first()->name}}</p>
                <input class="form-control" value="{{number_format($coming->first()->token_number,0,'','.')}}" disabled />
                <p class="tb-time" data-time="{{$coming->first()->start_date}}"><span class="test"></span></p>
                @if($user->kyc_status && $user->google2fa_enable)
                <button class="btn btn-buynow" disabled>Coming Soon</button>
                <!--                <a href="/token-sale/{{$coming->first()->id}}" class="btn btn-buynow" disabled>Coming Soon</a>-->
                @endif
            </div>
            @endif
        </div>
...
{{--@if(Route::current()->getName()=="ico.dashboard.index")--}}
{{--@endif--}}
@endsection