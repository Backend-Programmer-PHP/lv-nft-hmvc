                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/post/large/{{$value->image}}' class="rounded-circle"/></td>
                                            <td><a href="/{{Helper_Dashboard::get_patch()}}/{{Helper_Dashboard::get_patch(2)}}/photo/{{$value->id}}">Hình ảnh</a></td>
