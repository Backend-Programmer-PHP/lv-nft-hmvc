            ...
            <div class="card-box">
                ...
                <div class="form-group mb-2">
                    <select class="form-control form-control-sm" name="parent_id">
                        ...
                        <option value="{{$value->id}}" {{old('parent_id',$data->parent_id)==$value->id? "selected" :"" }}>{{$value->category_name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="form-group mb-2">
                    <label for="title">Category Name</label>
                    <input type="text" name="category_name" value="{{ old('category_name',$data->category_name) }}" class="form-control form-control-sm" placeholder="* tiêu đề">
                </div>
            </div>
        </div>
        <div class="col-md-4">
            <div class="card-box">
                ...
                @if($data->imageUri!="")
                <div class="form-group mb-2">
                    <img src="/public/upload/images/category/large/{{$data->imageUri}}" style="width: auto;max-width: 100%">
                </div>
                @endif
                <div class="form-group mb-2">
                    <?php
                ...
                <div class="form-group mb-2">
                    <label>Sort</label>
                    <input type="number" name="sort" value="{{ old('sort',$data->sort) }}" class="form-control form-control-sm" placeholder="1">
                </div>
