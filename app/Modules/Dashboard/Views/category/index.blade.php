                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="table-user"><img src='/public/upload/images/category/thumb/{{$value->imageUri}}' class="rounded-circle"/></td>
                                            <td><a href="/{{Helper_Dashboard::get_patch()}}/{{Helper_Dashboard::get_patch(2)}}/edit/{{$value->id}}" title="chỉnh sửa {{$value->category_name}}">{{$value->category_name}}</a></td>                                            
                                            <td>
                                                @if($value->status)
