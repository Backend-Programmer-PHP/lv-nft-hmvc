                            ...
                            <div class="table-responsive" data-pattern="priority-columns">
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        @php 
                                        $data_json = json_decode($value->hash);
                                        
                                        @endphp
                                        <tr>
                                            <th scope="row"><input type="checkbox" name="check[]" value="{{$value->id}}" /></th>
                                            <td><a target="_blank" href="https://ropsten.etherscan.io/tx/{{$data_json->transactionHash}}" title="{{$data_json->blockNumber}}">{{$data_json->blockNumber}}</a></td>
                                            <td><a target="_blank" href="https://ropsten.etherscan.io/address/{{$data_json->from}}" target="_blank">{{$data_json->from}}</a></td>
                                            <td>
                                                @if($data_json->status)
