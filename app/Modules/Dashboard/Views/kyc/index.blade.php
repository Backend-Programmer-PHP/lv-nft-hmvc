                                    ...
                                    <tbody>
                                        ...
                                        <tr data-id="{{$value->id}}">
                                            ...
                                            <td class="ekyc_status">
                                                @if(!empty($kyc_info) && $kyc_info->status)
                                            ...
                                            <td style="display:flex" data-ispay="{{$value->is_pay}}">
                                                ...
                                                <div class="dropdown mr-2">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right" x-placement="bottom-start">
                                                        <a class="dropdown-item text-success" href='/dashboard/kyc/send-bonus/{{$value->bonus_id}}'><i class="fe-check"></i> Accept Bonus</a>
                                                    </div>
                                                </div>
                                                @endif
                                                <div class="dropdown">
