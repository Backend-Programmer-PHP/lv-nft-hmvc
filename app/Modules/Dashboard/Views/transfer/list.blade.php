                                ...
                                <table class="table table-sm table-hover mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <th>
                                                @php 
                                                $hash = json_decode($value->hash);
                                                @endphp
                                                <a href="https://ropsten.etherscan.io/address/{{$value->address}}" target="_blank">{{$value->address}}</a>
                                            </th>
                                            <th>{{number_format($value->token_number,0,"",",")}}</th>                                            
                                            <td>
                                                @if($value->status)
                                            ...
                                            <!--td>
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right"  x-placement="bottom-start" >
                                                        <a class="dropdown-item text-danger" href='/{{Helper_Dashboard::get_patch()}}/{{Helper_Dashboard::get_patch(2)}}/send/{{$value->id}}'><i class="icon-cursor"></i> Transfer Token</a>
                                                    </div>
                                                </div>
                                            </td-->
                                        </tr>
